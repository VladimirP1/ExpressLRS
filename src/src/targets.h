...
#define GPIO_PIN_BUSY           -1   // NOT USED ON THIS TARGET
#define GPIO_PIN_DIO0           PB0 //confirmed on SLIMPLUS, R900MINI
...
#define GPIO_PIN_RST            PA2 //confirmed on SLIMPLUS, R900MINI
...
#define GPIO_PIN_RX_ENABLE      PC13
#define GPIO_PIN_TX_ENABLE      PC14
